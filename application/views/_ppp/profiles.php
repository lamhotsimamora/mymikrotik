...
<body>
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a onclick="saveSidebarActive('sidebar_ppp_profiles');"
                    href="<?= base_url('admin/router/') . $data_router->{'id_router'}."/ppp-profiles" ?>"
                    class="current">PPP Profiles</a>
            </div>
            <h1>PPP Profiles</h1>
        </div>
              ...
              <center>
                <button href="#modal_add" data-toggle="modal" class="btn btn-primary btn-mini">+</button>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered" id="ppp-profiles" v-cloak>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr v-for="(data,i) in data_profiles">
    ...
    <div class="modal-body">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <select v-model="local">
            <option v-for="local in data_local" :value="local.name">{{local.name}}</option>
          </select>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <select v-model="remote">
            <option v-for="remote in data_remote" :value="remote.name">{{remote.name}}</option>
          </select>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span4" ref="limit" v-model="limit" placeholder="1m/5m" />
        </div>
      </div>
    ...
    <script src="<?= base_url('public/') ?>ppp-profiles.js"></script>
