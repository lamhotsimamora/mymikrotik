...
<body>
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a onclick="saveSidebarActive('sidebar_hotspot_user');"
                    href="<?= base_url('admin/router/') . $data_router->{'id_router'}."/hotspot-user" ?>"
                    class="current">Multiple User</a>
                        ...
                        <div class="widget-content">
                            ...
                            <div id="form_generate_user" v-if="show_form" class="" v-cloak>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" class="form-control" ref="qty" v-model="qty"
                                            placeholder="Qty" />
                                    </div>
                                </div>
                         ...
                         rate_limit : profile['rate-limit']
                                ...
                                <div class="control-group">
                                    ...
                                    <center>
                                        <button @click="generate" :disabled="disabled_button"
                                            class="btn btn-primary btn-mini">Generate</button>
                                    </center>
                                </div>
                                <hr>
                            </div>
                            <center>
                                <button id="btn_show_form" @click="showForm" v-if="show_button"
                                    class="btn btn-primary btn-mini">Multiple</button>
                                <button onclick="goToSingleUser()" class="btn btn-warning btn-mini">New User</button>
                            </center>
                            <br>
                            <hr>
                         ...
                         <div id="search_tmp" >
                           <input id="input_search" class="span5" type="text" ref="search_query" @keypress="enterCari($event)"
    ...
    <script src="<?= base_url('public/') ?>user-multiple.js"></script>
