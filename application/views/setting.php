...
<script src="<?= base_url('public/'); ?>init.js"></script>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding collapse in">
                            <div id="setting_form" class="widget-content nopadding">
                                <form class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label">URL Server</label>
                                        <div class="controls">
                                            <input v-model="server" ref="server" type="text" class="span12"
    ...
    <script src="<?= base_url('public/') ?>setting.js"></script>
