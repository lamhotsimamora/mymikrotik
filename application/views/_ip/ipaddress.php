...
<body>
  ...
  <div id="content">
    <div id="content-header">
      ...
      <?php include dirname(__FILE__, 2).'/layout/small-header.php'; ?>
        <a onclick="saveSidebarActive('sidebar_ipaddress');" href="<?= base_url('admin/router/') . $data_router->{'id_router'}."/ipaddress" ?>" class="current">IP Address</a> 
      </div>
      <h1>IP Address</h1>
    </div>
        ...
        <div class="span12">
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered" id="ipaddress" v-cloak>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr v-for="(data,i) in data_ipaddress">
  ...
  <div id="modal_add" class="modal hide">
    ...
    <div class="modal-body">
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="span4" ref="ip_address" v-model="ip_address" placeholder="IP Address" />
        </div>
      </div>
  ...
  <script src="<?= base_url('public/') ?>ipaddress.js"></script>
